-- Insert match_events from end_turn, play_card, buy_card
...
begin
  ...
  values (p_match_id, v_match.turn_number, 'combat', v_events);
...
begin
  ...
  insert into match_events (match_id, turn_number, kind, payload)
  values (p_match_id, v_match.turn_number, 'play_card', jsonb_build_object('slot', p_slot, 'mana_cost', v_uc.mana_cost, 'final_atk', v_uc.final_atk, 'final_hp', v_uc.final_hp));
end;
$$;
...
begin
  ...
  insert into match_events (match_id, turn_number, kind, payload)
  values (p_match_id, v_match.turn_number, 'buy_card', '{}'::jsonb);
end;
$$;
