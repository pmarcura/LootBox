-- Update fuse_card to set user_cards.image_url from collectibles_catalog
...
begin
  ...
  insert into user_cards (user_id, token_id, vessel_inventory_id, strain_id, final_hp, final_atk, mana_cost, keyword, image_url)
  values (v_user_id, v_token_id, p_vessel_inventory_id, v_strain_row.strain_id, v_final_hp, v_final_atk, v_mana_cost, v_keyword, v_catalog.image_url)
  returning
    user_cards.id,
    user_cards.token_id,
    user_cards.final_hp,
